        ...
        <div class="admin-bodyqqaze">           
            <div class="row">
                <div class="col-12 view-complain">
                    ...
                    <?php }else{ ?>
                        <div class="row model-showdata">
                            <div class="col-md-12 text-center mt-3 mb-3 text-danger"><h4>ปกปิดข้อมูลผู้ร้องเรียน</h4></div>
                        </div>
                    <?php }?>
                                    ...
                                    <div class="log-detail pl-2">
                                        ...
                                        <?php }else if($v['type'] == 6){?>
                                            ...
                                            <?php if(isset($v['ask_unit'])){?>
                                                ...
                                                <?php }else{?>
                                                    <div class="pl-4 mb-2"><span class="text-info"><i class="fas fa-university"></i> คำตอบจากหน่วย : </span>
                                                    <button type="button" onclick="showcomment('<?=$token?>','<?=$v['comment_id']?>')" class="btn btn-warning btn-sm">ตอบข้อซักถาม</button>
                                                    </div>
                                                <?php }?>
                                            <?php }?>
...
<script>
function showcomment(token,com_id){
    $( ".showModel" ).load( "<?php echo base_url() ?>manage/showcomment?token="+token+"&comment="+com_id);
}
</script>
