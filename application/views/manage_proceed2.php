...
<div class="container">
    <div class="adminpage">
        ...
        <div class="admin-title"><i class="far fa-calendar-check"></i> หน่วยกำลังดำเนินการ</div>
        <div class="admin-search">
            <form id="frmSearch">
                <input type="hidden" name="page" id="page" value="1"/>
                <input type="hidden" name="s_status" value="4"/>
...
function viewcomplain(token){
    window.location.href = "<?php echo base_url()?>manage/viewcomplain/proceed?token="+token
}
