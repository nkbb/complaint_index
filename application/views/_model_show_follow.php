  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">ยืนยัน รายละเอียดการร้องเรียน-ร้องทุกข์</h5>
      ...
      <div class="modal-body">
        ...
        <?php if($type > 3){?>
        <div class="model-title" style="background: #00bb67;">ตอบ-แก้ไขข้อร้องเรียน (จาก หน่วย)</div>
        ...
        <?php if($type == 4){
            ...
            <div class="row model-showdata">
                <div class="col-md-12 text-center">
                    ...
                    <small>สามารถ สอบถามสถานะ ได้ที่ แถบเมนูจัดการ คลิกปุ่ม <i class="far fa-bell" style="font-size:22px;color: #007bff;"></i></small>
                </div>
            </div>
            <?php if($comment){?>
        ...
        <div class="row model-showdata">
            ...
            <div class="col-md-10 model-detail"><textarea class="form-control" id="answer_detail" name="answer_detail" rows="3"><?=$answer_detail?></textarea></div>
        </div>
        
            <input id="frmconfirm" type="hidden" name="token" value="<?=$token?>">
            <div class="row model-showdata">
        ...
        <div class="text-danger">กรุณาตรวจสอบการแก้ไขข้อร้องเรียนจากหน่วย และทำการยืนยัน อีกครั้ง!!!</div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">ปิด</button>
        <a href="javascript:confirmSubmit()" class="btn btn-primary">ยืนยันข้อมูล</a>
      </div>
...
function confirmSubmit(){
    var r = confirm("ยืนยันข้อมูลอีกครั้ง!");
    if (r == true) {
        var URL ="<?=base_url()?>manage/saveconfirm";
        var f = $("#frmconfirm").serialize();
        $.ajax({
            type: "GET",
            dataType: "html",
