...
<div class="container">
  <div class="adminpage">
    <div class="admin-title"><i class="fas fa-cog"></i> จัดการ ประเภทช่องทาง การแจ้งเรื่องร้องเรียน</div>
    <div class="admin-body">
        <div  class="row">
            <form id="myForm" action="<?=base_url()?>setting/method_save" method="post">
                
                <input type="hidden" name="ind" value="<?=(isset($ind)) ? $ind : '';?>"/>

                <div class="row input-data">
                    <label class="col-md-2 pl-5">รายละเอียด :</label>
                ...
                <div class="col-md-12 text-center mt-5 ">
                    ...
                    <a href="<?=base_url()?>setting/method_type" class="btn btn-light">ย้อนกลับ</a>
                </div>
            </form>
        </div>
    </div>
