...
<div class="w-100 bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- <div class="col-sm-12 bg-white rounded box-shadow mt-5"> -->
        <div class="w-100 mt-5 mb-5 text-center">
          <h2 class="text-title-content m-auto">แจ้งเรื่องร้องเรียน</h2>
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
    ...
    <div class="row pb-3">
      <div class="col-sm-12 bg-white rounded box-shadow mt-5 mb-5 panel-form-res-sm">
        <div class="w-100 mt-5 mb-5 text-center">
          <h2 class="text-title-content m-auto">ติดตามเรื่องร้องเรียน</h2>
        </div>
        <div class="row mb-5">
          <div class="col-md-4 offset-md-4">
            <div class="form-group form-group-res-sm">
              <label for="conplainCode">กรุณากรอก เลขที่ร้องเรียน</label>
...
<div class="container-fluid content-abouts pt-5 pb-5">
  <div>
    ...
    <div class="row">
      <div class="col-md-4 offset-md-4">
        ...
        <span class="ml-2" style='font-size:22px;'><?=$abouts["email"]?></span>
      </div>
    </div>
  </div>
</div>

<div class="fixdata ques">
  <a href="javascript:viewques()">แบบประเมิน</a>
</div>
<div class="fixdata manual">
  <a href="javascript:viewmanual()">คู่มือการใช้งาน</a>
</div>
...
function viewmanual(){
  $( ".showModel" ).load( "<?php echo base_url() ?>main/showmanual");
}
function serivceComplaint(id) {
  $.post("<?=base_url()?>complain/check_complaint_id", {id: id}, function() {
    window.location = "<?=base_url()?>complain";
  });
}
