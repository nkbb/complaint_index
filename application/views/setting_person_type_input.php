...
<div class="container">
  <div class="adminpage">
    <div class="admin-title"><i class="fas fa-cog"></i> จัดการ บุคคุลที่ถูกร้องเรียน</div>
    <div class="admin-body">
        <div  class="row">
            <form id="myForm" action="<?=base_url()?>setting/person_type_save" method="post">
                ...
                <div class="col-md-12 text-center mt-5 ">
                    ...
                    <a href="<?=base_url()?>setting/person_type" class="btn btn-light">ย้อนกลับ</a>
                </div>
            </form>
        </div>
    </div>
